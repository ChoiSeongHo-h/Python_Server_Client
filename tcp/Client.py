...
#private :
    ...
    def __RunDownloader(self, downloaderNum):
        ...
        downloader = Downloader(downloaderId, DownloaderInterfaceFunction)
        downloader.Run()
    ...
    def __RunUploader(self, uploadingFileName):
        ...
        uploader = Uploader(uploaderId, UploaderInterfaceFunction, uploadingFileName)
        uploader.Run()
...
#private :
    ...
    def __Upload2Server(self):                 #exeption
        ...
        interfaceFuncThread = Thread(target=self.__InterfaceFunction)
        interfaceFuncThread.start()
...
#public :
    def __init__(self, clientId, InterfaceFunction, uploadingFileName):
        #individual
...
#public :
    def __init__(self, clientId, InterfaceFunction):
        #individual
        self.__downloadingMode = 0
...
def DownloaderInterfaceFunction():
    print("ok")

def UploaderInterfaceFunction():
    print("ok")

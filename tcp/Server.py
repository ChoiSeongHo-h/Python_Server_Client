...
#private :
    ...
    def __Upload(self, clientRefVars):
        ...
        with open(self.__filePath+clientRefVars.uploadingFileName, "wb") as video:
            buffer = None
    ...
    def __OpenFile(self, clientId, downloadingFileName):
        openedFile = open(self.__filePath+downloadingFileName, "rb")
...
server.Run()
while True:
    print("num threads : ", active_count())
    time.sleep(1)
